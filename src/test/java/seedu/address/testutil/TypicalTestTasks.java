...
public class TypicalTestTasks {
    ...
    public static TestTask findAli, findBoris, findCarl, findDaniel, findElle, findFiona, findGeorge, findHoon, findIda, floatingTaskTestCase, tomorrowTaskTestCase;

    public TypicalTestTasks() {
        try {
            findAli =  new TaskBuilder().withTaskName("Find Ali").withReminder("20-11-2016 14:00").withPriority("1").withDueDate("20-12-2016 14:00").build();
            findBoris = new TaskBuilder().withTaskName("Find Boris").withReminder("31-12-2016 14:00").withPriority("3").withDueDate("31-12-2016 14:00").build();
            findCarl = new TaskBuilder().withTaskName("Find Carl").withDueDate("31-12-2016 14:00").withPriority("0").withReminder("20-11-2016 14:00").withTags("tedious").build();
    ...
    public static void loadAddressBookWithSampleData(AddressBook ab) {
        ...
        try {
            ab.addTask(new Task(findAli));
            ab.addTask(new Task(findBoris));
            ab.addTask(new Task(findCarl));
    ...
    public TestTask[] getTypicalTasks() {
        return new TestTask[]{findAli, findBoris, findCarl, findDaniel, findElle, findFiona, findGeorge};
    }
