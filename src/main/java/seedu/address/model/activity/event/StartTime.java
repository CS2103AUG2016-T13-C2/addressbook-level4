...
public class StartTime extends DateTime{
    public static final String MESSAGE_DUEDATE_CONSTRAINTS = "Task's Start Time should only contain valid date";
    public static final String MESSAGE_DUEDATE_INVALID = "start time has passed";
