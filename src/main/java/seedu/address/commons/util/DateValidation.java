...
public class DateValidation {
    ...
    public static String DateTimeToday(String date) {
        ...
        if (timeparts.length != 1) {
            ...
            return new SimpleDateFormat("dd-MM-yyyy HH:mm").format(new Date(today.getTime() + TimeUnit.HOURS.toMillis(4)));
    }

    public static String DateTimeTomorrow(String date) {
        String[] timeparts = date.split(" ");
        String part1 = timeparts[0];
        Date today = new Date();
        Date dayafter = new Date(today.getTime() + TimeUnit.DAYS.toMillis(1));
    ...
    public static String ReminderTimeToday(String date) {
        String[] timeparts = date.split(" ");
        String part1 = timeparts[0];
        Date today = new Date();
        String strDate = new SimpleDateFormat("dd-MM-yyyy").format(new Date());
        if (timeparts.length != 1) {
            ...
            return new SimpleDateFormat("dd-MM-yyyy HH:mm").format(new Date(today.getTime() + TimeUnit.HOURS.toMillis(3)));
    }
}